...
const MENU_ITEMS = [
  { icon: 'groups', label: 'Community', badge: 1, route: 'CommunitySettings' },
  { icon: 'history', label: 'Backup', badge: undefined, route: 'BackupData' },
  { icon: 'person-add', label: 'Manage added users', badge: undefined, route: 'ManageUsers' },
  { icon: 'lock', label: 'Password and Security', badge: undefined, route: 'PasswordSecurity' },
  { icon: 'location-on', label: 'Location access', badge: undefined, route: 'LocationAccess' },
  { icon: 'list-alt', label: 'My activity', badge: undefined, route: 'MyActivity' },
] as const;
