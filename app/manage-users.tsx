            ...
            >
              <View style={styles.userCardLeft}>
                {user.avatar ? (
                  ...
                  <View style={[styles.initialsAvatar, { backgroundColor: user.bgColor }]}>
                    <Text style={[styles.initialsText, { color: user.textColor }]}>{user.initials}</Text>
                  </View>
                )}
                <View style={styles.userInfo}>
                  <Text style={[styles.userName, { color: colors.text }]}>{user.name}</Text>
                  <Text style={[styles.userRole, { color: colors.textSub }]}>
                    {user.role}{user.access ? ` • ${user.access}` : ''}
                  </Text>
                </View>
              </View>
              {!user.isOwner && (
