...
const CONSENT_ITEMS: ConsentItem[] = [
  {
    id: 'terms',
    text: "I agree to Lily's",
    linkText: 'Terms of Service',
  },
  {
    id: 'privacy',
    text: "I have read Lily's",
    linkText: 'Privacy Policy',
  },
  {
    id: 'data',
    text: 'I agree to Lily processing the health data I choose to share with the app, so they can provide their services.',
  },
];
...
export default function PrivacyConsentScreen() {
  ...
  const handleNext = () => {
    // Save consent data and navigate to next screen
